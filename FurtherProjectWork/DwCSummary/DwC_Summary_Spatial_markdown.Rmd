...
```{r definition1,echo=FALSE,fig.keep='all'}
MAP<-function(X){
...
```
```{r definition2, echo=FALSE,fig.keep='all'}
CIRCLE<-function(X){
...
```
```{r definition3,echo=FALSE,fig.keep='all'}
NNN<-function(X){
...
```
```{r definition4 ,fig.keep='all',echo=FALSE}
CCC<-function(X,COORDINATEPRECISION=NULL,
...
```{r definition, echo = FALSE,fig.keep='all',warning=FALSE}
