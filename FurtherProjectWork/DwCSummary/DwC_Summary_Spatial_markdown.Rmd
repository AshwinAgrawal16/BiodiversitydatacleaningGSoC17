...
plot_map<-function(X){
  ...
  cat(paste("Area of the ploygon formed by the coordinates",pracma::polyarea(as.matrix(X[,1]),as.matrix(X[,2])),"\n"))
...
plot_table<-function(X,COORDINATEPRECISION=NULL,
  ...
  layout(title = 'CoordinatePrecision Plot')
    #b<-htmlTable(c_1)
    l[[i]]=b
    i=i+1
  ...
  layout(title = 'CoordinateUncertaintyInMeters Plot')
